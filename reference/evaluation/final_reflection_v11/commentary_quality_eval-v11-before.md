...
- `segment_count`: 235
- `event_type_counts`: {'period_transition': 26, 'celebration_or_replay': 29, 'other_relevant': 8, 'var_show': 1, 'dangerous_attack': 43, 'foul': 50, 'goal': 23, 'substitution': 8, 'shot': 21, 'save': 11, 'free_kick': 8, 'corner': 4, 'var_review': 2, 'penalty': 1}
- `generated_goal_count`: 23
- `verified_goal_count`: 8
- `goal_overcount`: 15
- `score_claim_segments`: 41
- `wrong_entity_segments`: 0
- `style_color_identity_segments`: 5
- `prematch_action_segments`: 0
- `unsupported_name_segments`: 1
- `mixed_language_segments`: 2
- `replay_goal_risk_segments`: 13

## Quality Gate / 质量门禁

- `status`: fail
- `blockers`: goal_overcount, score_claim_segments
...
| U023 | celebration_or_replay | `00:11:00-00:11:56` | Germany's No. 10 drives forward, threading a pass into the box. The ball finds a teammate who fires a shot from close range — it’s deflected by the Curacao goalkeeper in orange, bu |
...
| U047 | goal | `00:20:36-00:21:32` | Germany builds pressure in Curacao's half, with multiple attackers entering the penalty area. A German player takes a shot from inside the box, and the ball finds the back of the n |
| U049 | goal | `00:22:52-00:23:44` | Germany takes an early lead in this World Cup clash against Curacao. The breakthrough comes from a well-timed run by Germany's No. 17, Wirtz, who finds space inside the box and fir |
...
| U077 | goal | `00:34:52-00:36:12` | Germany's No. 17 takes a corner kick, delivering the ball into the penalty area. A German player heads the ball powerfully towards the goal, beating the goalkeeper and sending it i |
| U085 | goal | `00:37:24-00:38:36` | Germany's No. 17, Wirtz, drives forward with the ball, evading a Curacao defender in midfield. He enters the penalty area, drawing multiple defenders, and delivers a precise pass t |
...
| U111 | goal | `00:49:40-00:50:36` | Germany takes the lead! A German player drives into the box, draws defenders, and fires a shot that finds the back of the net as the goalkeeper dives in vain. The net ripples — goa |

### Unsupported named fact / 无依据人名

| Event | Type | Time | Excerpt |
| --- | --- | --- | --- |
| U032 | celebration_or_replay | `00:17:16-00:17:16` | Germany's No. 10, Müller, turns away as the crowd reacts — a moment of quiet aftermath after the goal. The scoreboard holds at 1-0, and the replay angle suggests this is part of th |

### Mixed-language Chinese / 中文夹杂英文

| Event | Type | Time | Excerpt |
| --- | --- | --- | --- |
| U193 | celebration_or_replay | `01:26:24-01:26:36` | Germany's Tah (No. 4) and Rügger (No. 7) celebrate with teammates and staff as the scoreboard confirms their 5-1 lead. The crowd roars in support, with fans waving 'Deutschland' sc |
| U205 | goal | `01:29:44-01:30:32` | Germany takes control in the attacking third, with a German player advancing into Curacao's half under pressure from a defender. The ball is delivered into the penalty area, and as |
...
| U023 | celebration_or_replay | `00:11:00-00:11:56` | Germany's No. 10 drives forward, threading a pass into the box. The ball finds a teammate who fires a shot from close range — it’s deflected by the Curacao goalkeeper in orange, bu |
| U028 | goal | `00:14:08-00:15:28` | Germany takes an early lead! Nmecha (No. 23) finds space in the box and fires a shot that beats the Curacao goalkeeper. The ball nestles into the back of the net, and the scoreboar |
| U030 | celebration_or_replay | `00:15:44-00:15:56` | The replay shows the moment Nmecha broke through Curacao's defense. With precise control, he dribbled past the midfield line and into the penalty area, evading retreating defenders |
| U032 | celebration_or_replay | `00:17:16-00:17:16` | Germany's No. 10, Müller, turns away as the crowd reacts — a moment of quiet aftermath after the goal. The scoreboard holds at 1-0, and the replay angle suggests this is part of th |
| U047 | goal | `00:20:36-00:21:32` | Germany builds pressure in Curacao's half, with multiple attackers entering the penalty area. A German player takes a shot from inside the box, and the ball finds the back of the n |
| U049 | goal | `00:22:52-00:23:44` | Germany takes an early lead in this World Cup clash against Curacao. The breakthrough comes from a well-timed run by Germany's No. 17, Wirtz, who finds space inside the box and fir |
| U062 | celebration_or_replay | `00:29:00-00:29:00` | Germany's No. 6, Havertz, reacts with visible frustration after a missed opportunity, hand on head as the scoreboard shows Germany leading 1-0 against Curacao. / 德国队6号哈弗茨错失良机后，双手抱头 |
| U068 | goal | `00:30:32-00:31:20` | Curacao strike early! A precise through ball finds the attacker inside the box, who fires a low shot past the German keeper into the bottom corner. The net ripples as the ball cros |
