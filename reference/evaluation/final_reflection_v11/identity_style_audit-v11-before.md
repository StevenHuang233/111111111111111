...
- `segment_count`: 235
- `color_identity_segments`: 3
- `team_identity_segments`: 227
- `number_identity_segments`: 137
- `role_identity_segments`: 172
- `raw_visual_segments`: 44
- `wrong_entity_segments`: 0
- `unsupported_name_segments`: 1
- `color_identity_ratio`: 0.0128
- `raw_visual_ratio`: 0.1872

## Style Gate / 风格门禁

- `status`: fail
- `blockers`: unsupported_name_segments
...
| --- | ---: | --- |
| Germany's No. 10 drives | 14 | U020 |
| A Curacao player goes | 7 | U055 |
| Germany make a change | 5 | U029 |
| Germany builds a dangerous | 5 | U057 |
| Germany's No. 19 drives | 4 | U044 |
| Germany's No. 19 takes | 4 | U061 |
| Curacao's No. 7 takes | 4 | U091 |
| And there it is | 3 | U021 |
| Germany takes an early | 3 | U028 |
| Germany's No. 17 takes | 3 | U077 |
| A German player goes | 3 | U088 |
| Germany takes the lead | 3 | U110 |
...
| U074 | period_transition | `00:33:20-00:33:24` | The teams are resetting on the pitch after the goal, with the scoreboard showing a 1-1 tie. Players from both Germany and Curacao are positioning themselves for the restart, while  |
