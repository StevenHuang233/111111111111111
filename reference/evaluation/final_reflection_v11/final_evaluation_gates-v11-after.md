...
| --- | --- | --- | --- | --- |
| quality | pass | - | - | generated_goal_count=8, verified_goal_count=8, goal_overcount=0, score_claim_segments=5, wrong_entity_segments=0, style_color_identity_segments=3 |
...
| identity_style | pass_with_warnings | - | raw_visual_segments | color_identity_segments=2, raw_visual_segments=43, wrong_entity_segments=0, unsupported_name_segments=0, color_identity_ratio=0.0085, raw_visual_ratio=0.183 |
